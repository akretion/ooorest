module Ooorest
  module Config
    module Fields
      ...
      # association type.
      #
      # @see Ooorest::Config::Fields.registry
      ...
      @@default_factory = lambda do |parent, properties, fields|
        ...
        if properties.has_key?(:model_proc)
          ...
          field = Ooorest::Config::Fields::Types.load("#{association[:polymorphic] ? :polymorphic : properties[:type]}_association").new(parent, properties[:name], association)
        else
          field = Ooorest::Config::Fields::Types.load(properties[:type]).new(parent, properties[:name], properties)
        end
        fields << field
        field
      end
      ...
      # @see ooorest/config/fields/factories/password.rb
      # @see ooorest/config/fields/factories/devise.rb
...
require 'ooorest/config/fields/factories/password'
require 'ooorest/config/fields/factories/enum'
require 'ooorest/config/fields/factories/devise'
require 'ooorest/config/fields/factories/paperclip'
require 'ooorest/config/fields/factories/dragonfly'
require 'ooorest/config/fields/factories/carrierwave'
require 'ooorest/config/fields/factories/association'
