...
module Ooorest
  module Config
    module Fields
      module Types
        class PolymorphicAssociation < Ooorest::Config::Fields::Types::BelongsToAssociation
          ...
          def associated_model_config
            @associated_model_config ||= association[:model_proc].call.map{|type| Ooorest.config(type) }.select{|config| !config.excluded? }
          end
