    ...
    module Actions
      ...
      class << self
        ...
        def add_action key, parent_class, parent, &block
          a = "Ooorest::Config::Actions::#{parent_class.to_s.camelize}".constantize.new
          a.instance_eval(%{
            #{parent} true
            def key
              :#{key}
...
require 'ooorest/config/actions/base'
require 'ooorest/config/actions/dashboard'
require 'ooorest/config/actions/index'
require 'ooorest/config/actions/show'
require 'ooorest/config/actions/show_in_app'
require 'ooorest/config/actions/history_show'
require 'ooorest/config/actions/history_index'
require 'ooorest/config/actions/new'
require 'ooorest/config/actions/edit'
require 'ooorest/config/actions/export'
require 'ooorest/config/actions/delete'
require 'ooorest/config/actions/bulk_delete'
